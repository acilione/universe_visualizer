...
export const scales = [
  { id:'solar', name:t("Solar System", "Sistema Solare"), short:t("Solar System", "Sistema Solare"), extent:t("60 AU", "60 UA"), unit:t("astronomical units", "unità astronomiche"), title:t("Solar System", "Sistema Solare"), subtitle:t("The Sun and eight planets · orbital distances in astronomical units.", "Il Sole e otto pianeti · distanze orbitali in unità astronomiche."), count:'8', metric:t("PLANETS", "PIANETI"), description:t("The Sun and its eight planets. Orbital distances are compressed and planetary sizes are enlarged for visibility.", "Il Sole e gli otto pianeti che gli orbitano intorno. Le distanze orbitali sono compresse per rendere visibili anche i mondi più vicini alla nostra stella."), source:sources.solar },
...
export const catalog = {
  ...
  stars:[object('sol',t("Sun", "Sole"),t("Reference star", "Stella di riferimento"),[0,0,0],t("0 ly", "0 a.l."),t("The Sun is the origin of this heliocentric reference frame.", "Il Sole è l’origine di questo sistema di riferimento eliocentrico."),'#ffe2a8'),...[
